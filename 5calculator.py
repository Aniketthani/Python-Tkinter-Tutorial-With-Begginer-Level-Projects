...
button_equal=Button(root,text="=",padx=130,pady=20,command=button_equal)
button_clear=Button(root,text="clear",padx=120,pady=20,command= button_clear)

button_subtract=Button(root,text="-",padx=61,pady=20,command=button_subtract)
button_divide=Button(root,text="/",padx=63,pady=20,command=button_divide)
